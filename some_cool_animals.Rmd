...
Here's where the info on ring-tails goes!

![Look at this little bugger! Shout outs to the Virginia Zoo](img/ringtail_cat.jpg) We'll also learn about 'knitr::include_graphics()'

Add a few fun facts about ringtails:

-They can rotate their hind feet 180 degrees!

-They're not endangered, but v elusive

-A close cousin to the raccoon, you might say
